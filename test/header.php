...
include 'include/customerID.php';// customerID retrive file
 ...
 $sql = "select * from admin_details where customerID='$custID'";
...
$run3=$conn->query($propsel);

$data3= $run3->fetch_assoc();
    ...
    <nav class="visible-sm visible-xs mobile-menu-container mobile-nav vk-menu-mobile-nav">
       ...
       <ul class="nav navbar-nav">
            <?php 
                ...
                $header_menu_run=$conn->query($header_menu_sql);
                while($header_menu_data=$header_menu_run->fetch_assoc()){
             ?>
