                ...
                <div class="row">
                    <div class="vk-slide">
                        <div id="owl-slide-home" class="owl-carousel owl-theme">
							...
							$slider_query="SELECT * FROM homeSlider WHERE customerID ='$custID'";
							$run2=$conn->query($slider_query);
							 
							 //$data2=$run2->fetch_assoc();
								//echo $data2;
							while( ($data2=$run2->fetch_assoc())!== NULL) { 
								
								?>
                                    <div class="item">
                                <div class="vk-item-slide">
                                    <div class="vk-item-img" style="background: url('https://res.cloudinary.com/<?php echo $cloud_name; ?>/image/upload/h_480,w_1500,c_fill/reputize/homepage-slider/<?php echo $data2['hsImg'];?>.jpg') no-repeat; background-size: cover; ">
                            ...
                            <div class="container">
                                <div class="vk-booking-transparent-2">
                                    <div class="vk-booking-head" style="padding-top: 10;padding-bottom: 30;">
                                        <h2>Reservation</h2>
                                        <p><?php echo $data1['reservationNo']; ?></p>
                                ...
                                <div class="vk-sparta-head-title">
                                    ...
                                    <div class="col-md-10 col-md-offset-1">
                                        <div class="vk-sparta-about-text">
                                            <p>
                                                <?php
                                                echo $data['aptgalleryheadcontent'];
                                            ...
                                            <div class="item">
                                                <div class="vk-sparta-item-content">
                                                    <div class="vk-item-img">
                                                        <a href="#"><img src="https://res.cloudinary.com/<?php echo $cloud_name; ?>/image/upload/c_fill/reputize/property/<?php echo $imagedata['imageURL']; ?>.jpg" alt="" class="img-responsive"></a>
                                                    </div>
                                                    <div class="vk-item-text">
                                                        <h2><a href="#"><?php echo $data3['propertyName']; ?></a></h2>
                                                        <ul>
                                                            <li>
                                                                <p>Starting Form : </p>
                                                            </li>
               ...
               <div class="vk-spa-our-services">
                    <div class="container">
                        ...
                        <div class="vk-spa-our-service-content">
                            ...
                            $services_head=$data['splheadcorporate'];
                            if ($services_head) {
                                # code...
                            ...
                            <div class="vk-spa-our-service-item">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-md-pull-6 vk-spa-our-service-info">
                                        ...
                                        <p><?php echo $data['splheadcorporatecontent']; ?>
                                        </p>
                                        <h5><span></span></h5>
                            ...
                            <div class="vk-spa-our-service-item">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 vk-spa-our-service-info">
                                        ...
                                        <p>
                                            <?php echo $data['splheadjpcontent']; ?>
                                        </p>
                                        <h5> <span> </span></h5>
                                        <h3><a href="#">VISIT</a></h3>
                                    </div>
                        ...
                        $services_head2=$data['splheadgoa'];
                        if ($services_head2) {
                             ?>
                            ...
                            <div class="vk-spa-our-service-item">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-md-pull-6 vk-spa-our-service-info">
                                        ...
                                        <p>
                                            <?php echo $data['splheadgoacontent']; ?>
                                        </p>
                                        <h5> <span> </span></h5>
                                        <h3><a href="#">VISIT</a></h3>
                                    </div>
                    ...
                    <div class="vk-testimonial-transparents-2">
                        <div class="vk-sparta-testimonial">
                            <div class="container">
                                <div class="vk-sparta-head-title">
                                    <h3>Testimonial</h3>
                                    <h2><?php echo $data['testimonialHead'] ?></h2>
                                    <div class="vk-sparta-about-border"></div>
                                </div>
